    ...
    <AdminLayout title="Users" breadcrumbs={['Admin', 'Users']}>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 mt-2 gap-4">
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-4 py-2 bg-white text-slate-600 font-bold text-sm border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors shadow-sm">
            <Filter size={16} />
            Filter
          </button>
          <button className="flex items-center gap-2 px-4 py-2 bg-white text-slate-600 font-bold text-sm border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors shadow-sm">
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-slate-50">
                <th className="px-6 py-5 text-xs font-bold text-slate-400">User</th>
                <th className="px-6 py-5 text-xs font-bold text-slate-400">Email</th>
                <th className="px-6 py-5 text-xs font-bold text-slate-400">City</th>
                <th className="px-6 py-5 text-xs font-bold text-slate-400">Joined</th>
                <th className="px-6 py-5 text-xs font-bold text-slate-400">Bookings</th>
