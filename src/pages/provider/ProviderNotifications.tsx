  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        ...
        // Auto-mark all as read when provider visits page
  ...
  return (
    <div className="space-y-6 max-w-[720px]">
      <div className="flex items-center justify-between">
        <h1 className="text-[22px] font-extrabold text-slate-900">Notifications</h1>
        <button
      ...
      <div className="bg-white rounded-[20px] shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-gray-100/60 overflow-hidden">
        {loading ? (
